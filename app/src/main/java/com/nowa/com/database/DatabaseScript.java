...
public class DatabaseScript extends Database {
	...
	private static final String[] SCRIPT_DATABASE_CREATE = new String[]{
			...
			//Hashtag_post
			"CREATE TABLE user_subject (id_user VARCHAR(240) NOT NULL, id_subject VARCHAR(240), FOREIGN KEY (id_user) REFERENCES user(id), FOREIGN KEY (id_subject) REFERENCES subject(id));",
            //Post
